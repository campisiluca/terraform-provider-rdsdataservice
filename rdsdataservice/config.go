...
type AWSClient struct {
	...
	ramconn                             *ram.RAM
	rdsconn                             *rds.RDS
	rdsdataserviceconn                  *rdsdataservice.RDSDataService
...
func (c *Config) Client() (interface{}, error) {
	...
	client := &AWSClient{
		...
		rdsdataserviceconn:                  rdsdataservice.New(sess.Copy(&aws.Config{Endpoint: aws.String(c.Endpoints["rdsdataservice"])})),
